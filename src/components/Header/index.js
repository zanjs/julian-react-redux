		...
		return (
			<div className="navbar-box navbar-skin">
			  ...
			  <div className="navbar-expanded">
			      <div>
				      <a className="navbar-item expanded-version" href="http://0.zanjs.com" title="React">
				        <img src='http://zanjs.b0.upaiyun.com/image/5/51/3eea1c91e5de49c97548a72908524.png' /> 
				      </a>				      
